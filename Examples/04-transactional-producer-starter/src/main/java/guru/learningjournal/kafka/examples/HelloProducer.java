...
public class HelloProducer {
    ...
    public static void main(String[] args) {
        ...
        producer.initTransactions(); // this method preforms the necessary check to ensures that any other transaction initiated by the previous instances of the same producer is closed
       ...
       // Code for the Rollback Scenerio
